...
class SearchField<T> extends StatefulWidget {
  ...
  /// Defines the height of the textfield
  final double? textFieldHeight;

  /// Defines content padding for the textfield
          ...
          (
            ...
            if (snapshot.data == null || !isSuggestionExpanded) {
              ...
              final Widget listView = ListView.builder(
                reverse: widget.suggestionDirection == SuggestionDirection.down,
      ...
      child: Stack(
        children: [
          Container(
            ...
            height: widget.textFieldHeight ?? 45,
          ),
          TextFormField(
            key: key,
            ...
            decoration:
                widget.searchInputDecoration?.copyWith(
                  ...
                  // labelStyle: AppColors.theme.textTheme.headlineMedium!
                  //     .copyWith(color: AppColors.greyColor),
                  // floatingLabelStyle:
                  //     AppColors.theme.textTheme.labelMedium!.copyWith(
                  ...
                  // hintStyle: AppColors.theme.textTheme.titleSmall,
                  filled:
                      !_focus!.hasFocus &&
            ...
            onChanged: (query) {
              ...
              if (widget.onSearchTextChanged != null) {
                ...
                for (final suggestion in widget.suggestions) {
                  ...
                  } else if (suggestion.searchKey.toLowerCase().contains(
                    query.toLowerCase(),
                  )) {
                    searchResult.add(suggestion);
                  }
